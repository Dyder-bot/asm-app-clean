...
const PARTNER_COMPATIBILITY_MESSAGES: Record<PartnerCompatibilityType, { single: string[]; multiple: string[] }> = {
  vma: {
    ...
    multiple: [
      "⚡ {names} ont des repères proches des tiens sur ce type de travail. S’ils partent sur le même exercice que toi, cela peut faire un bon petit groupe pour tenir les bonnes allures.",
      "🎯 {names} semblent avoir un niveau compatible avec le tien. Propose-leur la séance si vous choisissez le même objectif, c’est souvent plus motivant à plusieurs.",
      "🚀 {names} sont dans une zone proche de la tienne pour ce type d’effort rapide. Si vous partez sur la même séance, vous pouvez vous aider à garder des fractions propres.",
      "🤝 {names} peuvent être de bons repères d’allure pour toi ce soir. À voir ensemble s’ils choisissent le même exercice.",
    ],
  },
  threshold: {
    single: [
      "🎯 {names} a des repères proches des tiens pour ce type d’effort. Si vous choisissez la même séance, cela peut faire un bon binôme pour rester réguliers.",
      "🔥 {names} semble compatible avec ton niveau. Propose-lui de travailler ensemble si vous partez sur le même objectif.",
      "🤝 {names} peut être un bon partenaire d’allure sur ce type de séance. À confirmer ensemble selon l’exercice choisi.",
      "💪 {names} est proche de tes zones d’effort. Si vous faites la même séance, vous pouvez vous aider à garder l’intensité juste.",
    ],
    multiple: [
      "🎯 {names} ont des repères proches des tiens pour ce type d’effort. S’ils choisissent la même séance, cela peut faire un bon petit groupe pour rester réguliers.",
      "🔥 {names} semblent compatibles avec ton niveau. Propose-leur de travailler ensemble si vous partez sur le même objectif.",
      "🤝 {names} peuvent être de bons partenaires d’allure sur ce type de séance. À confirmer ensemble selon l’exercice choisi.",
      "💪 {names} sont proches de tes zones d’effort. Si vous faites la même séance, vous pouvez vous aider à garder l’intensité juste.",
    ],
  },
  trail: {
    single: [
